...
export default function HeroSection() {
	return (
		<section
			className="w-full bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]"
			id="hero-section"
		>
			...
			<div className="w-full my-4 px-4 mx-auto text-center lg:py-16">
